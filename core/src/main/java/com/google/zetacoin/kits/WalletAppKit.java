...
package com.google.zetacoin.kits;
...
import com.google.zetacoin.store.SPVBlockStore;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV mazacoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit mazacoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing mazacoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the mazacoinj website for further details.
     */
