 ...
 * {@link com.google.zetacoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.zetacoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.google.zetacoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.zetacoin.net.StreamParser)}
     * or
     * {@link com.google.zetacoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.zetacoin.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // mazacoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link com.google.zetacoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.zetacoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.zetacoin.core.Peer#ping()} has never
