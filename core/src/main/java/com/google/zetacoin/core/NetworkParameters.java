...
public abstract class NetworkParameters implements Serializable {
   ...
   ("04ffff001d010445466562727561727920352c20323031343a2054686520426c61636b2048696c6c7320617265206e6f7420666f722073616c65202d203138363820497320546865204c415721");
            ...
            t.addOutput(new TransactionOutput(n, t, Utils.toNanoCoins(5000, 0), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
        ...
        genesisBlock.setMerkleRoot(new Sha256Hash("62d496378e5834989dd9594cfc168dbb76f84a39bbda18286cddc7d1d1589f4f"));
        return genesisBlock;
    }

    // Difficulty calculation parameters
    public static final int TARGET_TIMESPAN = 60 * 2 * 4;  // 8 minutes per difficulty cycle, on average.
  ...
  //public static final int MAX_ADJUST_UP = 1; // 1% adjustment up
    public static final int MAX_ADJUST_UP = 15; // 15% adjustment up
