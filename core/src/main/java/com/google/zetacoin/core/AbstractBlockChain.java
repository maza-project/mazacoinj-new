 ...
 * the lightweight SPV mode, a {@link com.google.zetacoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.zetacoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
